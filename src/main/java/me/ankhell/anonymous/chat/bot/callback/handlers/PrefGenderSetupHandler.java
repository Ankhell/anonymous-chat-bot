...
@Singleton
public class PrefGenderSetupHandler implements CallbackQueryHandler {

  private final MessageProvider messageProvider;
  private final UserRepository userRepository;

  public PrefGenderSetupHandler(
  ...
  public boolean wouldProcess(CallbackData callbackData) {
    return callbackData.getActionType() == ActionType.UPDATE_SEX_PREF;
  }
  ...
  public List<BotApiMethod<?>> handleInlineQuery(
    ...
    result.add(messageProvider.getAgeQueryMessage(callbackQuery.getFrom().getId(),ActionType.UDATE_PREF_MIN_AGE));
    return result;
  }
}
